        ...
        <div className="min-h-screen bg-zinc-950 text-white flex flex-col">
            ...
            <div className="px-6 pb-20 max-w-4xl mx-auto text-center">
                ...
                <p className="text-zinc-400 leading-relaxed">
                    Our system uses neural networks trained on historical stock data.
                    The model learns patterns from past price movements and attempts to
                    estimate short-term future trends. It processes sequences of previous
                    prices and indicators, identifying relationships that may not be obvious
                    to humans.
                </p>
                <p className="text-zinc-400 mt-4 leading-relaxed">
                    While the model continuously improves and aims for high accuracy,
                    financial markets are inherently unpredictable and influenced by many
                    external factors.
                </p>
            </div>

            {/* PRICING */}
            <div className="px-6 pb-20 max-w-5xl mx-auto grid md:grid-cols-2 gap-6">

                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                    <h3 className="font-semibold mb-2">Free Plan</h3>
                    <p className="text-sm text-zinc-400">
                        Access basic predictions and track a limited number of stocks.
                    </p>
                </div>
                ...
                <div className="bg-zinc-900 border border-green-500 rounded-xl p-6">
                    ...
                    <p className="text-sm text-zinc-400">
                        View multiple predictions at once on your dashboard, track more
                        stocks, and gain deeper insights for better decision-making.
                    </p>
                </div>
            </div>
            ...
            <div className="px-6 pb-20 max-w-3xl mx-auto text-center">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                    ...
                    constitute financial advice. Predictions generated by the model are
                    not guaranteed and should not be treated as certain outcomes.
                </p>
                <p className="text-sm text-zinc-400 mt-3 leading-relaxed">
                    Always do your own research and consider multiple sources before making
                    any investment decisions. Use this tool as a support, not as a single
                    source of truth.
                </p>
            </div>
